...
\section{Architecture web et modèle relationnel}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \item LEMP : Linux, Nginx, MySQL, PHP-FPM — a largement remplacé LAMP ;
            \item MERN : MongoDB, Express, ReactJS, Node.js — pour du JavaScript côté serveur.
        \end{itemize}
    \end{frame}
    ...
    \begin{frame}
        ...
        \textbf{Inconvénients :}
        \begin{itemize}
            \item Peu de tolérance à la charge
            \item Augmentation complexe des performances
        \end{itemize}
    \end{frame}
