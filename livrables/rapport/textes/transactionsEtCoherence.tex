...
\subsection{Isolation de la transaction}
	...
	La norme SQL définit 4 niveaux d'isolation afin de résoudre les trois principales problématiques d'isolation (lecture sale, lecture non reproductible et lecture fantôme) le plus efficacement possible :
	\vspace{10px}
	\begin{itemize}
