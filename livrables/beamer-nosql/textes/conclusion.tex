    ...
    \subsection{Bonnes pratiques}
        ...
        \begin{frame}
            ...
            \begin{itemize}
                ...
                \item \textbf{IA:} recherche sémantique, RAG, mémoire des agents (BDD vectorielles)
                \item \dots
            \end{itemize}
        \end{frame}
    ...
    \subsection{NoSQL ou relationnel ?}
        ...
        \begin{frame}
            ...
            \begin{tabular}{|p{0.20\textwidth}|p{0.40\textwidth}|p{0.30\textwidth}|}
                ...
                Vectorielles
                & Vecteurs (embeddings) représentant le sens des contenus
                & Recherche sémantique, RAG \\\hline
            \end{tabular}
