...
\begin{document}
	...
	\addcontentsline{toc}{chapter}{Introduction : pourquoi le NoSQL ?}
	\minitoc
	...
	\minitoc
		...
		\label{sec:BDDDocuments}
      		\input{textes/BDDDocuments}

		\section{Les bases de données orientées graphes}
		\label{sec:BDDGraphes}
			\input{textes/BDDGraphes}

		\section*{Conclusion}
			\input{textes/conclusionImplementations}
