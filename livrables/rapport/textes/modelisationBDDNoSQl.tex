...
\subsection{La gestion de la redondance des données}
	...
	\subsubsection{Duplication de la clé-primaire}
		...
		Par exemple, imaginons que l'on modélise une relation \enquote{plusieurs vers plusieurs} entre des livres et des auteurs. L'enregistrement de l'auteur contiendrait la liste des clés primaires de ses livres et le livre contiendrait les clés primaires de ses auteurs. On commencerait par récupérer les identifiants des auteurs puis on interrogerait les livres pour récupérer le reste des données.
