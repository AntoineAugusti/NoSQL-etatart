...
\section{Types de bases de données NoSQL}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \item \textbf{Principaux acteurs :} Redis, Valkey, Memcached, Amazon DynamoDB.
        \end{itemize}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \item \textbf{Principaux acteurs :} MongoDB, CouchDB, Couchbase, Google Firestore.
        \end{itemize}
    \end{frame}
    ...
    \begin{frame}
        \frametitle{Exemple d'une requête MongoDB}
    ...
    \subsection{Bases de données orientées recherche}
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \item \textbf{Principaux acteurs :} Elasticsearch, OpenSearch, Meilisearch, Typesense.
        \end{itemize}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            \item \textbf{Modélisation SQL :} utilisation des colonnes JSON ou JSONB, création d'index de recherche full-text ;
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \item \textbf{Principaux acteurs :} Neo4j, JanusGraph, Memgraph, Amazon Neptune.
        \end{itemize}
    \end{frame}
